...
class EtisalatDataBuyForFriendAdapter(
  private val context: Context,
  private val onDataAmountClickListener: OnEtisalatDataAmountClickListener
) : RecyclerView.Adapter<EtisalatDataBuyForFriendAdapter.ViewHolder?>() {
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    data_full_values = listOf(*context.resources.getStringArray(R.array.etisalat_full_data_array))
