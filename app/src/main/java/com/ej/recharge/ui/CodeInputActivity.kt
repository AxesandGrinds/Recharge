...
//        // TODO Remove For Release ^^^
    ...
    mAdView.adListener = object : AdListener() {
      ...
      override fun onAdLoaded() {
        ...
        Log.e(TAG, "CodeInputActivity onAdLoaded")
      }

      override fun onAdFailedToLoad(adError: LoadAdError) {
        // Code to be executed when an ad request fails.
        Log.e(TAG, "CodeInputActivity onAdFailedToLoad: ${adError.toString()}")
      }

      override fun onAdOpened() {
        // Code to be executed when an ad opens an overlay that
        // covers the screen.
        Log.e(TAG, "CodeInputActivity onAdOpened")
      }

      override fun onAdClicked() {
        // Code to be executed when the user clicks on an ad.
        Log.e(TAG, "CodeInputActivity onAdClicked")
      }
      ...
      override fun onAdClosed() {
        ...
        Log.e(TAG, "CodeInputActivity onAdClosed")
      }
