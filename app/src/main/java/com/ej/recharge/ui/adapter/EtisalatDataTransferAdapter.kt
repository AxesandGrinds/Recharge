...
class EtisalatDataTransferAdapter(
  private val context: Context,
  private val onDataAmountClickListener: OnEtisalatDataAmountClickListener
) : RecyclerView.Adapter<EtisalatDataTransferAdapter.ViewHolder?>() {
...
//  private var code: List<String>? = null
  ...
  interface OnEtisalatDataAmountClickListener {
    fun onEtisalatDataAmountClicked(code: String, data: String, fullData: String, amount: String)
  }
...
//    code = listOf(*context.resources.getStringArray(R.array.etisalat_code_array))
    amount_values = listOf(*context.resources.getStringArray(R.array.etisalat_amount_options_array))
    data_values = listOf(*context.resources.getStringArray(R.array.etisalat_data_options_array))
    data_full_values = listOf(*context.resources.getStringArray(R.array.etisalat_full_data_full_options_array))
    valid_values = listOf(*context.resources.getStringArray(R.array.etisalat_full_data_valid_options_array))
