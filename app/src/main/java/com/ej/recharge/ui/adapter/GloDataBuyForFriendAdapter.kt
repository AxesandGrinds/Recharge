...
class GloDataBuyForFriendAdapter(
  private val context: Context,
  private val onDataAmountClickListener: OnGloDataAmountClickListener
) : RecyclerView.Adapter<GloDataBuyForFriendAdapter.ViewHolder?>() {
  ...
  interface OnGloDataAmountClickListener {
    fun onGloDataAmountClicked(code: String, data: String, fullData: String, amount: String)
  }
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    code = listOf(*context.resources.getStringArray(R.array.glo_code_array))
    amount_values = listOf(*context.resources.getStringArray(R.array.glo_amount_array))
    data_values = listOf(*context.resources.getStringArray(R.array.glo_data_array))
    data_full_values = listOf(*context.resources.getStringArray(R.array.glo_full_data_array))
    valid_values = listOf(*context.resources.getStringArray(R.array.glo_valid_array))
    ...
    Handler().postDelayed({
      object : CountDownTimer(duration, 50) {
        ...
        override fun onFinish() {
          ...
          onDataAmountClickListener.onGloDataAmountClicked(
