...
class PleaseWaitScreenHomeActivity : AppCompatActivity(),
  ...
  override fun onInterstitialLoaded(interstitial: MoPubInterstitial?) {
    Log.e(TAG, "PleaseWaitScreenHomeActivity onInterstitialLoaded")
  }

  override fun onInterstitialFailed(interstitial: MoPubInterstitial?, error: MoPubErrorCode?) {
    Log.e(TAG, "PleaseWaitScreenHomeActivity onInterstitialFailed: ${error.toString()}")
  ...
  override fun onInterstitialShown(interstitial: MoPubInterstitial?) {
    Log.e(TAG, "PleaseWaitScreenHomeActivity onInterstitialShown")
  }

  override fun onInterstitialClicked(interstitial: MoPubInterstitial?) {
    Log.e(TAG, "PleaseWaitScreenHomeActivity onInterstitialClicked")
  }

  override fun onInterstitialDismissed(interstitial: MoPubInterstitial?) {

    Log.e(TAG, "PleaseWaitScreenHomeActivity onInterstitialDismissed")
    goToMain()
...
//    loadInterstitialAd()
  ...
  private fun goToMain() {
    ...
    val intent = Intent(this@PleaseWaitScreenHomeActivity, MainActivity::class.java)
