...
import com.ej.recharge.presenter.UserMenuItemClickListener
import com.ej.recharge.repository.entity.User
import com.ej.recharge.utils.Util

class HomeUserMainItemViewHolder(
  ...
  private val phone1Tv: TextView = view.findViewById(R.id.phoneTv)
  private val network1Tv: TextView = view.findViewById(R.id.networkTv)
  private val menu: ImageButton = view.findViewById(R.id.menu1)
  ...
  private fun initPopup(user: User, view: View) {
    ...
    popup.setOnMenuItemClickListener(UserMenuItemClickListener(context, fragment, activity, user, "1"))
  ...
  override fun bind(model: User) {
    ...
    model.run {
      ...
      if (phone != null) {
        ...
        phone1Tv.visibility = View.INVISIBLE
      }

      if (network != null) {
        network1Tv.text = network
      }
      else {
        network1Tv.visibility = View.INVISIBLE
      }
