...
import kotlinx.android.synthetic.main.vision_activity_still_image.*
...
@KeepName
class LiveCaptureCameraActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContentView(R.layout.vision_activity_still_image)
    findViewById<View>(R.id.select_image_button)
      .setOnClickListener { view: View ->
        // Menu for selecting either: a) take new photo b) select from existing
        val popup =
          PopupMenu(this@LiveCaptureCameraActivity, view)
