...
public class InferenceInfoGraphic extends GraphicOverlay.Graphic {
  ...
  public synchronized void draw(Canvas canvas) {
    ...
    canvas.drawText("Input Image size: " + overlay.getImageHeight() + "x" + overlay.getImageWidth(), x, y, textPaint);

    // Draw FPS (if valid) and inference latency
    if (framesPerSecond != null) {

      canvas.drawText(
          "FPS: " + framesPerSecond + ", Frame latency: " + frameLatency + " ms", x, y + TEXT_SIZE, textPaint);
