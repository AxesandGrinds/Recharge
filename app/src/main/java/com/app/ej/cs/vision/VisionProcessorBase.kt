...
import com.app.ej.cs.vision.BitmapUtils
import com.app.ej.cs.vision.CameraImageGraphic
import com.app.ej.cs.vision.FrameMetadata
import com.app.ej.cs.vision.GraphicOverlay
import com.app.ej.cs.vision.InferenceInfoGraphic
import com.app.ej.cs.vision.ScopedExecutor
import com.app.ej.cs.vision.VisionImageProcessor
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
  ...
  private fun requestDetectInImage(
    ...
    return detectInImage(image)?.addOnSuccessListener(executor) {
      ...
      if (frameProcessedInOneSecondInterval == 1) {
        ...
        Log.d(TAG, "Frame latency: max=$maxFrameMs, min=$minFrameMs, avg=" +
