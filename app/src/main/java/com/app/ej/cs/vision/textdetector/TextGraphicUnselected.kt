...
package com.app.ej.cs.vision.textdetector
...
import com.app.ej.cs.vision.GraphicOverlay.Graphic
 ...
 * overlay view.
 */
class TextGraphicUnselected constructor(overlay: GraphicOverlay?, private val text: Text) :
  Graphic(overlay) {
