...
class AirtelDataRechargeAdapter(
...
) : RecyclerView.Adapter<AirtelDataRechargeAdapter.ViewHolder?>() {
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    amount_values = listOf(*context.resources.getStringArray(R.array.airtel_amount_array))
    data_values = listOf(*context.resources.getStringArray(R.array.airtel_data_array))
    valid_values = listOf(*context.resources.getStringArray(R.array.airtel_valid_array))
